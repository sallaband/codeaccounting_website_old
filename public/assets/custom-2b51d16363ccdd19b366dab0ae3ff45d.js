...
function showRegisterForm(){
    ...
    $('.loginBox').fadeOut('fast',function(){
        ...
        $('.modal-title').html('Get started today');
        $('.modal-subtitle').html('Enter your information below and we will be in contact with you shortly. Thank you for your interest in CodeAccounting.');
    });
...
function showLoginForm(){
    ...
    $('#loginModal .registerBox').fadeOut('fast',function(){
        ...
        $('.modal-title').html('Sign up for <span>CodeAccounting</span>');
        $('.modal-subtitle').html('Enter your contact information');
    });
    $('.error').removeClass('alert alert-danger').html('');
}
    ...
    if (isdonut == 1){}
            ...
            var doughnut2Data = [
                ...
                },
                {
                    ...
                    color: "#323A45",
                    highlight: "#4C5B70",
                    label: "Increased Variable Expenses"
                },
                {
                    value: 12,
                    color: "#2980B9",
                ...
                datasets : [
                    {
                        ...
                        data : [100000,200000,200000,150000,250000,370000,320000]
                    },
                    {
                        ...
                        data : [200000,230000,330000,570000,740000,810000,960000]
                    }
                ]
